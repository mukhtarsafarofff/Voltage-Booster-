(ENG) This boost converter is used to "step-up" an input voltage to some higher level, required by a load and is based on NE555 and TL431 Integrated Circuits.
